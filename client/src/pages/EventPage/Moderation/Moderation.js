...
class Moderation extends Component {
  ...
  render() {
    return (
      <div className="">
        <button className="btn btn-success" onClick={() => this.moderateEvent(this.props.id, true)}>
          ok
        </button>
        <button className="btn btn-danger" onClick={() => this.moderateEvent(this.props.id, false)}>
          no
        </button>
      </div>
    );
